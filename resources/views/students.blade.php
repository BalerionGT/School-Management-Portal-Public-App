            ...
            <table class="crud">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$student->year}}</td>
                        <td>
                            <a href="{{route('student.edit', ['student'=>$student->id])}}" class="btn btn-info">Editer</a>
                            <a href="#" class="btn btn-danger" onclick="if(confirm('Voulez-vous vraiment supprimer cet étudiant?')){document.getElementById('form-{{$student->id}}').submit()}" >Supprimer</a>
                            <form id="form-{{$student->id}}" action="{{route('student.supprimer', ['student'=>$student->id])}}" method="post">
                                @csrf
