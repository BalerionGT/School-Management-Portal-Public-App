...
<body>
    <div class="wrapper">
        ...
        <div class="mt-4">
            ...
            @endif
            <form style="width:65%" method="post" action="{{route('module.ajouter')}}">
                @csrf
                <div class="form-group">
                    <label for="exampleInputNom">Nom</label>
                    <input type="text" class="form-control" placeholder="Enter nom" name="nom_module">
                </div>
                <label>Fillière</label><br>
                <select name="fillière">
                    <option selected disabled>Fillière</option>
                    @foreach ($fillières as $fillière)
                ...
                <a href="{{route('module')}}" type="Ajouter" class="btn btn-danger">Annuler</a>
            </form>
        </div>
        <!-- main-content -->
        <!--=================================
