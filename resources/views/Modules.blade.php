...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div>
            <a href="{{route('module.create')}}" class="btn btn-primary">Ajouter un module</a>
        </div>
        <div>
            <table class="crud">
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('module.edit', ['module'=>$module->id])}}" class="btn btn-info">Editer</a>
                            <a href="#" class="btn btn-danger" onclick="if(confirm('Voulez-vous vraiment supprimer ce module?')){document.getElementById('form-{{$module->id}}').submit()}" >Supprimer</a>
                            <form id="form-{{$module->id}}" action="{{route('module.supprimer', ['module'=>$module->id])}}" method="post">
                                @csrf
