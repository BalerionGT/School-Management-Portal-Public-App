        ...
        <div class="side-menu-fixed">
            <div class="scrollbar side-menu-bg">
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        <a href="{{ route('profil.prof') }}"><i class="ti-user"></i><span class="right-nav-text">Profil
                            </span></a>
                    </li>
                    <!-- menu item Cours-->
                    <li>
                        <a href="{{route('Uploadcours')}}"><i class="ti-book"></i><span class="right-nav-text">Cours
                            </span></a>
                    </li>
                    <!-- menu item Calendrier-->
                    <li>
                        <a href="{{route('calendar.prof')}}"><i class="ti-calendar"></i><span class="right-nav-text">Emploie
                            </span></a>
                    </li>
