...
<html lang="en">
    ...
    @endif
        <form style="width:65%" method="post" action="{{route('element.update', ['element'=> $element->id ])}}">
            ...
            <input type="text" class="form-control" placeholder="Enter nom" name="nom_elt" value="{{$element->nom}}">
            </div>
            <div class="form-group">
            ...
            <a href="{{route('element.ajouter')}}" type="Ajouter" class="btn btn-danger">Annuler</a>
        </div>
        </form>
    <!-- main-content -->
    <!--=================================
